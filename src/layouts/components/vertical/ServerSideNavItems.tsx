...
// ** Api Services
import navigationApi from 'src/@api-center/navigation/navigationApiService'
...
const ServerSideNavItems = () => {
  ...
  useEffect(() => {
    axios
      .get(navigationApi.myMenu, {
        headers: {
          Authorization: "Bearer " + window.localStorage.getItem(navigationApi.storageTokenKeyName)!
        }
      })
      .then(response => {
