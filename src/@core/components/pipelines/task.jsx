...
const avatars = [
  { index: 1, nome: 'Alan', avatar: '/images/avatars/2.png' },
  { index: 1, nome: 'Gustavo', avatar: '/images/avatars/1.png' },
  { index: 1, nome: 'Tiago', avatar: '/images/avatars/3.png' }
]
          ...
          >
            <Grid container spacing={0} sx={{ marginTop: 1 }}>
              ...
              >
                ...
                >
                  {avatars.map(x => {
                    ;<Avatar key={x.index} alt={x.nome} src={x.avatar} />
                  })}
                </AvatarGroup>
              </Grid>
            </Grid>
