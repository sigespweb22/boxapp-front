      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>Seja bem vindo ao {themeConfig.templateName}! 🌋</TypographyStyled>
              <Typography variant='body2'>Faça login na sua conta e comece a aventura</Typography>
            </Box>
